...
import { Bot, History, Loader2, PencilLine, RotateCcw, Save, Sparkles } from 'lucide-react'
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[88vh] overflow-hidden border-white/10 bg-[#07101c] p-0 text-white sm:max-w-6xl">
        ...
        <div className="grid gap-0 lg:grid-cols-[1.45fr_0.95fr]">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Textarea
                          ...
                          rows={10}
                          className="min-h-[220px] resize-y border-white/10 bg-slate-950/70 font-mono text-[13px] leading-6 text-slate-100 placeholder:text-slate-500 focus-visible:ring-violet-500"
                        />
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Textarea
                          ...
                          rows={18}
                          className="min-h-[360px] resize-y border-white/10 bg-slate-950/70 font-mono text-[13px] leading-6 text-slate-100 placeholder:text-slate-500 focus-visible:ring-violet-500"
                        />
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <Textarea
                          ...
                          rows={10}
                          className="min-h-[220px] resize-y border-white/10 bg-slate-950/70 font-mono text-[13px] leading-6 text-slate-100"
                        />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium uppercase tracking-[0.2em] text-slate-400">
                        ...
                        <Textarea
                          ...
                          rows={18}
                          className="min-h-[360px] resize-y border-white/10 bg-slate-950/70 font-mono text-[13px] leading-6 text-slate-100"
                        />
                      </div>
                    </div>
                  )}
          ...
          <aside className="max-h-[calc(88vh-94px)] overflow-y-auto bg-white/[0.03] px-6 py-5">
